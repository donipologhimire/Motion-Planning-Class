...
% [doTwoSegmentsIntersect,intersection_point] = doTwoSegmentsIntersect(p1,p2,p3,p4)
% doTwoSegmentsIntersect takes two segments described by their respective
% vertices p1, p2 and p3, p4 and returns the answer true(1) or false(0), and if
% the answer is true(1), the intersection point
% Haley Ekstrom 81786834 May 9, 2021
...
% sort points s.t. p1<p2, p3<p4, p1<=p3
